...
export const createService = async (req, res, next) => {
    ...
    if (service.status === "Active") {
        ...
        for (let index = 0; index < users.length; index++) {
            await sendEmail(users[index].email, `${req.body.advertisementName} New Service ✨🔥`, `<!DOCTYPE html>
    <html>
    <head>
        <!--[if !mso]><!-- -->
                                                                                    ...
                                                                                    <div style="text-align:start;">
                                                                                        ...
                                                                                        <table style="width:100%; border-collapse: collapse;">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="padding: 10px;">
                                                                                                    <h3 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif; font-weight: 500; font-size: 16px;color: #46D7D4;">${service.name}</h3>
